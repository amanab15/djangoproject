"""
Django settings for gravience project.
...
SECRET_KEY = 'django-insecure-r($eh3s67=^lge8liet!bof%t67s$z9u+y=a7y+8gm)_9ddau*'
...
LOGIN_REDIRECT_URL = 'viewdata'  # or any named URL in your urls.py
